...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public class XRGrabInteractable2 : XRBaseInteractable
    {
        ...
        protected virtual void Drop()
        {
            ...
            else if (transform.parent != m_OriginalSceneParent && m_RetainTransformParent && gameObject.activeInHierarchy)
